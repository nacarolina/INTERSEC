...
(function (window, document, $) {
    ...
    function PosicionarTitulo() {
        var navMenu = $('#navMenu').height();
        if (navMenu > 80) {

            $('#liTitulo').css('display', 'none');
            navMenu = $('#navMenu').height();

            $('#div_Conteudo_Titulo').css('display', 'block');
            $('#div_Margin_Titulo').css('margin-top', '0');
            $('#div_Margin_Titulo').css('margin-left', '0');

            $('#divTitulo_Mobile').html($('#liTitulo').html());
            $('#divTitulo_Mobile').css('display', 'block');
            $('#liTitulo').html('');
        }
        else {
            $('#liTitulo').css('display', 'block');
            $('#liTitulo').html(html_titulo);
          
            $('#divTitulo_Mobile').html('');
            $('#divTitulo_Mobile').css('display', 'none');
