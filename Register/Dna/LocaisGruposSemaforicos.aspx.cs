...
{
    public partial class LocaisGruposSemaforicos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string idDna = db.ExecuteScalarQuery("Select IdDna from status Where Serial='" + hdfIdEqp.Value + "'");
                hdfIdDna.Value = idDna;
            }
        }
