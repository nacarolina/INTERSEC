...
(function (factory) {
    ...
    DEFAULT_PREVIEW = '<div class="file-preview-other">\n' +
        ...
        '</div>';
    var FinalizouUpload = false;
    var QtdUploadEnviado = 0;
    var QtdUploadEnviar = 0;
    function VerificarFinalizouUpload() {
        if (FinalizouUpload == true) {
            ...
            setTimeout(VerificarFinalizouUpload, 500);
    ...
    FileInput.prototype = {
        ...
        _uploadClick: function (e) {
            ...
            if (isEnabled) {
                ...
                var i = 0;
                QtdUploadEnviado = 0;
                QtdUploadEnviar = self.filestack.length;
                FinalizouUpload = false;
                VerificarFinalizouUpload();
                self.filestack.forEach(function (f) {
                    var name = self.filenames[i];
                        ...
                        if (TipoUpload == "Imagem") {
                                        $.ajax({
                                            ...
                                            success: function (data) {
                                                QtdUploadEnviado++;
                                                if (QtdUploadEnviado == QtdUploadEnviar) {
                                                    FinalizouUpload = true;
                                                }
                                            }
                ...
                , error: function (xmlHttpRequest, status, err) {
                    ...
                    reader.readAsDataURL(self.filestack[i]);
                    i++;
